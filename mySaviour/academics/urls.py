...
urlpatterns = [
    ...
    path('course_<int:course_id>/year_<int:year>/', views.documents, name = "documents"),
    path('course_<int:course_id>/year_<int:year_number>/type_<int:type_id>/', views.show_documents, name = "show_documents"),
